...
import specificationsPhoto from '../../images/specifications.jpg'
...
export const Specifications = () => {
  return (
    <div className='specifications'>
      <div className='specifications__container'>
        ...
        <div className='specifications__cell'>
          ...
          <div className='specifications__table'>
            <div className='specifications__container_name'>
            ...
            <div className='specifications__container_text'>
      ...
      <img src={specificationsPhoto} alt='Фото характеристики' className='specifications__photo' />
    </div>
  )
}